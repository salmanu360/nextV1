                ...
                <div className="flex">
                  ...
                  <div className="hs-dropdown ti-dropdown block ltr:ml-auto rtl:mr-auto my-auto">
                    ...
                    <div className="hs-dropdown-menu ti-dropdown-menu">
                      <a className="ti-dropdown-item" href="javascript:void(0)">
                        Download
                      </a>
                      <a className="ti-dropdown-item" href="javascript:void(0)">
                        Import
                ...
                <ul className="flex flex-col">
                  <li className="px-0 pt-0 ti-list-group border-0 text-gray-800 dark:text-white">
                    ...
                    >
                      ...
                      <div className="">
                        <span className="text-sm font-medium">$1,835</span>
                      </div>
                    </a>
                  </li>
                  <li className="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                    ...
                    >
                      ...
                      <div className="">
                        <span className="text-sm font-medium">$2,415</span>
                      </div>
                    </a>
                  </li>
                  <li className="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                  ...
                  <li className="px-0 pt-3 ti-list-group border-0 text-gray-800 dark:text-white">
                    ...
                    >
                      ...
                      <div className="">
                        <span className="text-sm font-medium">$1,035</span>
                      </div>
                    </a>
                  </li>
              ...
              <div className="box-body">
                <ul className="flex flex-col">
                  <li className="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white">
                    <a href="javascript:void(0);" className="w-full">
              ...
              <div className="box-body p-0">
                <div className="overflow-auto">
                  <table className="ti-custom-table ti-custom-table-head">
                    <thead>
                      <tr>
                        <th scope="col" className="text-center !p-[0.65rem]">
                          Product
                        </th>
                        <th scope="col" className="!p-[0.65rem]">
                          Category
                        </th>
                        <th scope="col" className="!p-[0.65rem]">
                          Stock
